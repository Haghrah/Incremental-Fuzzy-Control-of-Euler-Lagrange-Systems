...
from TSK import (PSO, TSK, stringSolution, gaussian, IAE, saveSolution, )
...
if __name__ == "__main__":
    ...
    def errorFunc(P, TSKN1, TSKM1, TSKN2, TSKM2):
        P1Len = TSKM1 * (2 * TSKN1 + 1)
        P2Len = TSKM2 * (2 * TSKN2 + 1)
        TSKCtrl1 = TSK(P[:P1Len], TSKN1, TSKM1, 
                       [[gaussian, ] * TSKN1, ] * TSKM1,  )
        TSKCtrl2 = TSK(P[P1Len:P1Len + P2Len], TSKN2, TSKM2, 
                       [[gaussian, ] * TSKN2, ] * TSKM2,  )
        myRobot = EulerLagrange(TSKCtrl1, TSKCtrl2)
    ...
    myPSO = PSO(25, P1Len + P2Len, 
                errorFunc, args=(TSKN1, TSKM1, TSKN2, TSKM2, ))
    for i in range(50):
        myPSO.iterate()
        print("Iteration ", i+1, ".", myPSO.fb)
    P0 = myPSO.xb
    print(stringSolution(P0))
    TSKCtrl1 = TSK(P0[:P1Len], TSKN1, TSKM1, 
                   [[gaussian, ] * TSKN1, ] * TSKM1, )
    TSKCtrl2 = TSK(P0[P1Len:P1Len + P2Len], TSKN2, TSKM2, 
                   [[gaussian, ] * TSKN2, ] * TSKM2, )
