...
from RBFN import (PSO, RBFN, stringSolution, IAE, saveSolution, )
...
if __name__ == "__main__":
    ...
    def errorFunc(P, RBFNCtrlN1, RBFNCtrlM1, RBFNCtrlN2, RBFNCtrlM2):
        P1Len = 1 + RBFNCtrlN1 * (RBFNCtrlM1 + 2)
        P2Len = 1 + RBFNCtrlN2 * (RBFNCtrlM2 + 2)
        RBFNCtrl1 = RBFN(RBFNCtrlN1, RBFNCtrlM1, P[:P1Len], )
        RBFNCtrl2 = RBFN(RBFNCtrlN2, RBFNCtrlM2, P[P1Len:P1Len + P2Len], )
        myRobot = EulerLagrange(RBFNCtrl1, RBFNCtrl2)
    ...
    myPSO = PSO(25, P1Len + P2Len, 
                errorFunc, args=(RBFNCtrlN1, RBFNCtrlM1, RBFNCtrlN2, RBFNCtrlM2, ))
    for i in range(50):
        myPSO.iterate()
        print("Iteration ", i+1, ".", myPSO.fb)
    P0 = myPSO.xb
    print(stringSolution(P0))
    RBFNCtrl1 = RBFN(RBFNCtrlN1, RBFNCtrlM1, P0[:P1Len], )
    RBFNCtrl2 = RBFN(RBFNCtrlN2, RBFNCtrlM2, P0[P1Len:P1Len + P2Len], )
